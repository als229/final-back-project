...
import com.kh.finalproject.content.model.dto.ContentSearchDTO;
...
public class ContentController {
	...
	public ResponseEntity<Void> insertContent(
	    ...
	    System.out.println(">>> firstImage = " + (firstImage != null ? firstImage.getOriginalFilename() : "null"));
	...
	public ResponseEntity<DetailContentDTO> getContentDetail(@PathVariable("contentId") Long contentId) {
	    DetailContentDTO detail = contentService.getContentDetail(contentId);
	...
	/*
	@GetMapping("/search")
	public ResponseEntity<List<ContentCardDTO>> searchContents(
	    @RequestParam(required = false) Long categoryCode,
	    @RequestParam(required = false) String regionName,
	    @RequestParam(required = false) String keyword
	) {
	    List<ContentCardDTO> result = contentService.searchContents(categoryCode, regionName, keyword);
